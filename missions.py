...
def trip_1():
    ...
    TurningPID_abs(-50)
    print("Accomplished")
    StraightPID_abs(-50, 45, 40, slow_stop=1)
    TurningPID_abs(56)
    ...
    i = 1
    while i<5:
        StraightPID_abs(58, 18, 57, slow_stop=0)
        wait_for_seconds(0.25)
        StraightPID_abs(58, 15, -29, slow_stop=0)
        wait_for_seconds(0.25)
        #TurningPID_abs(47)
        wait_for_seconds(0.5)
        i = i+1
 
    #Navigating to Hybrid Car
    StraightPID_abs(50, 13, -47, slow_stop=1)
    TurningPID_abs(-43)
    StraightPID_abs(-43, 39, 45)
...
initialize()
StraightPID_abs(0, 50, 50)
TurningPID_abs(-20)
wait_for_seconds(0.5)
StraightPID_abs(-22, 40, 40)
StraightPID_abs(-22, -5, 50)


StraightPID_abs(0, 50, 50)
TurningPID_abs(-20)
wait_for_seconds(0.5)
StraightPID_abs(-22, 40, 80)
StraightPID_abs(-22, -10, 50)
wait_for_seconds(0.1)
StraightPID_abs(-22, 10, 80)
StraightPID_abs(-22, -10, 50)
wait_for_seconds(0.1)
StraightPID_abs(-22, 10, 80)
StraightPID_abs(-22, -10, 50)